...
if classIndexId == 7 then --Only do this if we're on a Shaman!
	...
	local function ElementalConstructBarColorsAndBehaviorPanel(parent)
		...
		yCoord = yCoord - 30
		yCoord = TRB.Functions.OptionsUi:GenerateBarDisplayOptions(parent, controls, spec, 5, 3, yCoord, "Maelstrom", "notEmpty", true, "Earth Shock/Elemental Blast", "ES/EB")
		...
		controls.colors.borderOvercap = TRB.Functions.OptionsUi:BuildColorPicker(parent, "Border color when your current hardcast will overcap Maelstrom", spec.colors.bar.borderOvercap, 300, 25, oUi.xCoord, yCoord)
