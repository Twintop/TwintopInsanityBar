...
function TRB.Options:ConstructOptionsPanel()
	...
	local localeText2 = string.format(percentFormat, 89.58)
	localeText2 = localeText2 .. "\n" .. string.format(percentFormat, 15.82)
	localeText2 = localeText2 .. "\n" .. string.format(percentFormat, 100.00)
	localeText2 = localeText2 .. "\n" .. string.format(percentFormat, 0.34)
	localeText2 = localeText2 .. "\n" .. string.format(percentFormat, 0.34)
	localeText2 = localeText2 .. "\n" .. string.format(percentFormat, 12.12)
	localeText2 = localeText2 .. "\n" .. string.format(percentFormat, 0.34)
	localeText2 = localeText2 .. "\n" .. string.format(percentFormat, 0.34)
	localeText2 = localeText2 .. "\n" .. string.format(percentFormat, 0.34)
	localeText2 = localeText2 .. "\n" .. string.format(percentFormat, 0.34)
	localeText2 = localeText2 .. "\n" .. string.format(percentFormat, 0.34)
	localeText2 = localeText2 .. "\n" .. string.format(percentFormat, 99.72)
	localeText2 = localeText2 .. "\n" .. string.format(percentFormat, 0.34)
