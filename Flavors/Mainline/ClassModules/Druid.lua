...
TRB.Functions.Bootstrap:RegisterClassModule({
	...
	fillSpellData = { FillSpellData_Balance, FillSpellData_Feral, FillSpellData_Guardian, FillSpellData_Restoration },
	---The form the setup starts from; the shapeshift handler keeps it current afterwards.
	OnBeforeReady = function()
		TRB.Data.character.currentShapeshiftFormId = 0
		TRB.Data.character.currentShapeshiftForm = "humanoid"
	end,
	extraEvents = { "COOLDOWN_VIEWER_SPELL_OVERRIDE_UPDATED" },
	---Ravage replaces Ferocious Bite through a Cooldown Manager spell override; mirror that onto the
	---Ravage snapshot so bar text and thresholds follow the override.
	OnEvent = function(event, baseSpellId, overrideSpellId)
