			...
			if not specSettings.displayBar.stagger.neverShow then
				...
				if barGroups and barGroups.stagger then
					...
					if staggerNode then
						...
						Bar:ApplyNodeIndicators(staggerNode, "staggerBar")
				...
				for x = 1, TRB.Data.character.maxResource2 do
					...
					if barGroups and barGroups.secondary then
						...
						if chiNode then
							...
							Bar:ApplyNodeIndicators(chiNode, "chiBar")
						end
					end
				end
			end
...
TRB.Functions.Bootstrap:RegisterClassModule({
	...
	fillSpellData = { FillSpellData_Windwalker, FillSpellData_Mistweaver }, -- Brewmaster fills its spell data inside SwitchSpec
})
