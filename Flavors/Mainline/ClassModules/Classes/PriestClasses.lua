...
do
	...
	-- /trb holywords prints the Holy Word diagnostics the Priest runtime module implements.
	SpecDescriptor:DeclareForClass("priest", {
		slashCommands = {
			holywords = function()
	...
	SpecDescriptor:Declare("priest_discipline", {
		manaBar = true,
