...
-- Mainline changelog shown by the News window (Core\Functions\News.lua renders it). Markdown; newest
-- release first. Each flavor ships its own changelog because their class rosters and release lines differ.
