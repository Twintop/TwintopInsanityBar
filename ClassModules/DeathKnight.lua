...
local function ConstructResourceBar(settings)
	...
	for thresholdId = 1, 4 do-- TRB.Data.character.maxResource2-1 do
...
local function RefreshLookupData_Blood()
	...
	lookupLogic["$casting"] = _castingRunicPower
	...
	if TRB.Data.character.specId == 1 then
		...
		if snapshotData.attributes.isTracking then
			...
			if specSettings.displayBar.neverShow == false then
				...
				for x = 1, TRB.Data.character.maxResource2 do
					local rune = TRB.Data.character.runes[x]
...
function TRB.Functions.Class:IsValidVariableForSpec(var)
	...
	elseif var == "$resource" or var == "$runicPower" then
