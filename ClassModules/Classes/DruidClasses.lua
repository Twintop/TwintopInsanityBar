...
---@field public moonfire TRB.Classes.SpellBase
---@field public berserk TRB.Classes.SpellBase
---@field public berserkPersistence TRB.Classes.SpellBase
...
function TRB.Classes.Druid.GuardianSpells:New()
    ...
    self.rebirth = TRB.Classes.SpellThreshold:New({
        id = 20484,
        baseline = true,
        settingKey = "rebirth",
    ...
    self.berserkPersistence = TRB.Classes.SpellBase:New({
        id = 50334,
        isTalent = true,
        nodeId = 82144
    })
    self.berserkUncheckedAggression = TRB.Classes.SpellBase:New({
        id = 50334,
        isTalent = true,
        nodeId = 82155
    })
