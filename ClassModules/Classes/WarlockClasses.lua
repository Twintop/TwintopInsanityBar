...
function TRB.Classes.Warlock.AfflictionSpells.FillBarTextVariables(specCacheEntry)
	...
	specCacheEntry.barTextVariables.values = TRB.Functions.BarText:GetCommonValues({
		{ variable = "$mana", description = L["WarlockAfflictionBarTextVariable_mana"], printInSettings = true, color = false, secret = true },
		{ variable = "$resource", description = "", printInSettings = false, color = false, secret = true },
		{ variable = "$manaPercent", description = L["WarlockAfflictionBarTextVariable_manaPercent"], printInSettings = true, color = false, secret = true },
		...
		{ variable = "$soulShardsPlusCasting", description = L["WarlockAfflictionBarTextVariable_soulShardsPlusCasting"], printInSettings = true, color = false },
...
function TRB.Classes.Warlock.DemonologySpells.FillBarTextVariables(specCacheEntry)
	...
	specCacheEntry.barTextVariables.values = TRB.Functions.BarText:GetCommonValues({
		{ variable = "$mana", description = L["WarlockDemonologyBarTextVariable_mana"], printInSettings = true, color = false, secret = true },
		{ variable = "$resource", description = "", printInSettings = false, color = false, secret = true },
		{ variable = "$manaPercent", description = L["WarlockDemonologyBarTextVariable_manaPercent"], printInSettings = true, color = false, secret = true },
		{ variable = "$resourcePercent", description = "", printInSettings = false, color = false, secret = true },
		...
		{ variable = "$comboPointsMax", description = "", printInSettings = false, color = false },
		{ variable = "$soulShardsPlusCasting", description = L["WarlockDemonologyBarTextVariable_soulShardsPlusCasting"], printInSettings = true, color = false },
		{ variable = "$comboPointsPlusCasting", description = "", printInSettings = false, color = false },
...
function TRB.Classes.Warlock.DestructionSpells.FillBarTextVariables(specCacheEntry)
	...
	specCacheEntry.barTextVariables.values = TRB.Functions.BarText:GetCommonValues({
		{ variable = "$mana", description = L["WarlockDestructionBarTextVariable_mana"], printInSettings = true, color = false, secret = true },
		{ variable = "$manaPercent", description = L["WarlockDestructionBarTextVariable_manaPercent"], printInSettings = true, color = false, secret = true },
		...
		{ variable = "$comboPointsMax", description = "", printInSettings = false, color = false },
		{ variable = "$soulShardsPlusCasting", description = L["WarlockDestructionBarTextVariable_soulShardsPlusCasting"], printInSettings = true, color = false },
		{ variable = "$comboPointsPlusCasting", description = "", printInSettings = false, color = false },
