...
local function BalanceConstructOptionsPanel(cache)
	...
	yCoord = TRB.Functions.OptionsUi:BuildTabGroup(parent, namePrefix, {
		...
		{ key = "thresholds", label = L["TabThresholds"], width = oUi.tabWidth.large, constructor = BalanceConstructThresholdListPanel },
...
local function FeralConstructOptionsPanel(cache)
	...
	yCoord = TRB.Functions.OptionsUi:BuildTabGroup(parent, namePrefix, {
		...
		{ key = "thresholds", label = L["TabThresholds"], width = oUi.tabWidth.large, constructor = FeralConstructThresholdListPanel },
...
local function GuardianConstructOptionsPanel(cache)
	...
	yCoord = TRB.Functions.OptionsUi:BuildTabGroup(parent, namePrefix, {
		...
		{ key = "thresholds", label = L["TabThresholds"], width = oUi.tabWidth.large, constructor = GuardianConstructThresholdListPanel },
