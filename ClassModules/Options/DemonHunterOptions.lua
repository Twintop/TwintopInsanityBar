...
local function DevourerConstructThresholdPanel(parent)
	...
	--[[yCoord = yCoord - 25
	controls.checkBoxes.chaosNovaThresholdShow = CreateFrame("CheckButton", "TwintopResourceBar_DemonHunter_Devourer_Threshold_Option_chaosNova", parent, "ChatConfigCheckButtonTemplate")
	f = controls.checkBoxes.chaosNovaThresholdShow
	f:SetPoint("TOPLEFT", oUi.xCoord, yCoord)
	getglobal(f:GetName() .. 'Text'):SetText(L["DemonHunterDevourerThresholdCheckboxChaosNova"])
	f.tooltip = L["DemonHunterDevourerThresholdCheckboxChaosNovaTooltip"]
	f:SetChecked(spec.thresholds.thresholdDictionary.chaosNova.enabled)
	f:SetScript("OnClick", function(self, ...)
		spec.thresholds.thresholdDictionary.chaosNova.enabled = self:GetChecked()
	end)
	...
	yCoord = yCoord - 25
	controls.checkBoxes.chaosStrikeThresholdShow = CreateFrame("CheckButton", "TwintopResourceBar_DemonHunter_Devourer_Threshold_Option_chaosStrike", parent, "ChatConfigCheckButtonTemplate")
	f = controls.checkBoxes.chaosStrikeThresholdShow
	f:SetPoint("TOPLEFT", oUi.xCoord, yCoord)
	getglobal(f:GetName() .. 'Text'):SetText(L["DemonHunterDevourerThresholdCheckboxChaosStrikeAnnihilation"])
	f.tooltip = L["DemonHunterDevourerThresholdCheckboxChaosStrikeAnnihilationTooltip"]
	f:SetChecked(spec.thresholds.thresholdDictionary.chaosStrike.enabled)
	f:SetScript("OnClick", function(self, ...)
		spec.thresholds.thresholdDictionary.chaosStrike.enabled = self:GetChecked()
		spec.thresholds.thresholdDictionary.annihilation.enabled = self:GetChecked()
	...
	yCoord = yCoord - 25
	controls.checkBoxes.eyeBeamThresholdShow = CreateFrame("CheckButton", "TwintopResourceBar_DemonHunter_Devourer_Threshold_Option_eyeBeam", parent, "ChatConfigCheckButtonTemplate")
	f = controls.checkBoxes.eyeBeamThresholdShow
	f:SetPoint("TOPLEFT", oUi.xCoord, yCoord)
	getglobal(f:GetName() .. 'Text'):SetText(L["DemonHunterDevourerThresholdCheckboxEyeBeam"])
	f.tooltip = L["DemonHunterDevourerThresholdCheckboxEyeBeamTooltip"]
	f:SetChecked(spec.thresholds.thresholdDictionary.eyeBeam.enabled)
	f:SetScript("OnClick", function(self, ...)
		spec.thresholds.thresholdDictionary.eyeBeam.enabled = self:GetChecked()
	end)
	...
	yCoord = yCoord - 25
	controls.checkBoxes.felBarrageThresholdShow = CreateFrame("CheckButton", "TwintopResourceBar_DemonHunter_Devourer_Threshold_Option_felBarrage", parent, "ChatConfigCheckButtonTemplate")
	f = controls.checkBoxes.felBarrageThresholdShow
	f:SetPoint("TOPLEFT", oUi.xCoord, yCoord)
	getglobal(f:GetName() .. 'Text'):SetText(L["DemonHunterDevourerThresholdCheckboxFelBarrage"])
	f.tooltip = L["DemonHunterDevourerThresholdCheckboxFelBarrageTooltip"]
	f:SetChecked(spec.thresholds.thresholdDictionary.felBarrage.enabled)
	f:SetScript("OnClick", function(self, ...)
		spec.thresholds.thresholdDictionary.felBarrage.enabled = self:GetChecked()
	end)
	...
	yCoord = yCoord - 25
	controls.checkBoxes.glaiveTempestThresholdShow = CreateFrame("CheckButton", "TwintopResourceBar_DemonHunter_Devourer_Threshold_Option_glaiveTempest", parent, "ChatConfigCheckButtonTemplate")
	f = controls.checkBoxes.glaiveTempestThresholdShow
	f:SetPoint("TOPLEFT", oUi.xCoord, yCoord)
	getglobal(f:GetName() .. 'Text'):SetText(L["DemonHunterDevourerThresholdCheckboxGlaiveTempest"])
	f.tooltip = L["DemonHunterDevourerThresholdCheckboxGlaiveTempestTooltip"]
	f:SetChecked(spec.thresholds.thresholdDictionary.glaiveTempest.enabled)
	f:SetScript("OnClick", function(self, ...)
		spec.thresholds.thresholdDictionary.glaiveTempest.enabled = self:GetChecked()
	end)
	...
	yCoord = yCoord - 25
	controls.checkBoxes.throwGlaiveThresholdShow = CreateFrame("CheckButton", "TwintopResourceBar_DemonHunter_Devourer_Threshold_Option_throwGlaive", parent, "ChatConfigCheckButtonTemplate")
	f = controls.checkBoxes.throwGlaiveThresholdShow
	f:SetPoint("TOPLEFT", oUi.xCoord, yCoord)
	getglobal(f:GetName() .. 'Text'):SetText(L["DemonHunterDevourerThresholdCheckboxThrowGlaive"])
	f.tooltip = L["DemonHunterDevourerThresholdCheckboxThrowGlaiveTooltip"]
	f:SetChecked(spec.thresholds.thresholdDictionary.throwGlaive.enabled)
	f:SetScript("OnClick", function(self, ...)
		spec.thresholds.thresholdDictionary.throwGlaive.enabled = self:GetChecked()
	end)
