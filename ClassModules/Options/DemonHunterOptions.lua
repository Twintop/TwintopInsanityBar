...
local function HavocConstructIndicatorColorsPanel(parent)
	...
	for rowIndex, nodeKey in ipairs(orderedKeys) do
		...
		if def and indicator then
			...
			-- Targets dropdown
			local ddName = "TwintopResourceBar_DemonHunter_Havoc_Indicator_" .. nodeKey .. "_Targets"
	...
	for gradIdx, gradKey in ipairs(orderedGradientKeys) do
		...
		if gradDef and gradIndicator then
			...
			-- Targets dropdown
			local ddName = "TwintopResourceBar_DemonHunter_Havoc_Gradient_" .. gradKey .. "_Targets"
			local dd = CreateFrame("DropdownButton", ddName, parent, "WowStyle1DropdownTemplate")
			dd:SetWidth(280)
			dd:SetPoint("TOPLEFT", xOffset, yCoord)
			dd:SetScript("OnEnter", function(self)
	...
	-- End of Metamorphosis Configuration section
	yCoord = yCoord - 10
...
local function VengeanceConstructIndicatorColorsPanel(parent)
	...
	-- Gradient indicators cannot target soul fragment fill (different scales: stepped 1-6 vs fury 0-120)
	local gradientExcludedElements = {
	...
	for rowIndex, nodeKey in ipairs(orderedKeys) do
		...
		if def and indicator then
			...
			-- Targets dropdown
			local ddName = "TwintopResourceBar_DemonHunter_Vengeance_Indicator_" .. nodeKey .. "_Targets"
			local dd = CreateFrame("DropdownButton", ddName, parent, "WowStyle1DropdownTemplate")
			dd:SetWidth(280)
			dd:SetPoint("TOPLEFT", xOffset, yCoord)
			dd:SetScript("OnEnter", function(self)
	...
	for gradIdx, gradKey in ipairs(orderedGradientKeys) do
		...
		if gradDef and gradIndicator then
			...
			-- Targets dropdown
			local ddName = "TwintopResourceBar_DemonHunter_Vengeance_Gradient_" .. gradKey .. "_Targets"
			local dd = CreateFrame("DropdownButton", ddName, parent, "WowStyle1DropdownTemplate")
			dd:SetWidth(280)
			dd:SetPoint("TOPLEFT", xOffset, yCoord)
			dd:SetScript("OnEnter", function(self)
