...
local function BrewmasterConstructOptionsPanel(cache)
	...
	local tabDefinitions = {
		...
		{ "thresholds", L["TabThresholds"], oUi.tabWidth.large, BrewmasterConstructThresholdListPanel },
...
local function WindwalkerConstructOptionsPanel(cache)
	...
	local tabDefinitions = {
		...
		{ "thresholds", L["TabThresholds"], oUi.tabWidth.large, WindwalkerConstructThresholdListPanel },
