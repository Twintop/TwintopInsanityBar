...
local function BeastMasteryConstructOptionsPanel(cache)
	...
	local tabDefinitions = {
		...
		{ "thresholds", L["TabThresholds"], oUi.tabWidth.large, BeastMasteryConstructThresholdListPanel },
...
local function MarksmanshipConstructOptionsPanel(cache)
	...
	local tabDefinitions = {
		...
		{ "thresholds", L["TabThresholds"], oUi.tabWidth.large, MarksmanshipConstructThresholdListPanel },
...
local function SurvivalConstructOptionsPanel(cache)
	...
	local tabDefinitions = {
		...
		{ "thresholds", L["TabThresholds"], oUi.tabWidth.large, SurvivalConstructThresholdListPanel },
