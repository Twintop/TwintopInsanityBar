...
local function AssassinationConstructOptionsPanel(cache)
	...
	local tabDefinitions = {
		...
		{ "thresholds", L["TabThresholds"], oUi.tabWidth.large, AssassinationConstructThresholdListPanel },
...
local function OutlawConstructOptionsPanel(cache)
	...
	local tabDefinitions = {
		...
		{ "thresholds", L["TabThresholds"], oUi.tabWidth.large, OutlawConstructThresholdListPanel },
...
local function SubtletyConstructOptionsPanel(cache)
	...
	local tabDefinitions = {
		...
		{ "thresholds", L["TabThresholds"], oUi.tabWidth.large, SubtletyConstructThresholdListPanel },
