...
---@diagnostic disable-next-line: undefined-field
	...
	local function SubtletyConstructBarColorsAndBehaviorPanel(parent)
		...
		controls.colors.comboPoints.shadowTechniques = TRB.Functions.OptionsUi:BuildColorPicker(parent, "PLACEHOLDER FOR SHADOW TECHNIQUES", spec.colors.comboPoints.shadowTechniques, 300, 25, oUi.xCoord2, yCoord)
