...
if classIndexId == 5 then --Only do this if we're on a Priest!
	...
	local function LoadDefaultSettings()
		...
		elseif specId == 3 then
			return ShadowLoadDefaultSettings()
		else
			return {}
		end
	end
	...
	local function ShadowConstructOptionsLayoutPanel()
		...
		StaticPopupDialogs["TwintopInsanityBar_ResetBarTextSimple"] = {
			...
			button2 = "No",
			OnAccept = function()
				TRB.Data.settings.displayText = ShadowLoadDefaultBarTextSimpleSettings()
				ReloadUI()			
			end,
			timeout = 0,
			whileDead = true,
		...
		StaticPopupDialogs["TwintopInsanityBar_ResetBarTextAdvanced"] = {
			...
			button2 = "No",
			OnAccept = function()
				TRB.Data.settings.displayText = ShadowLoadDefaultBarTextAdvancedSettings()
				ReloadUI()			
			end,
			timeout = 0,
			whileDead = true,
		...
		StaticPopupDialogs["TwintopInsanityBar_ResetBarTextNarrowAdvanced"] = {
			...
			button2 = "No",
			OnAccept = function()
				TRB.Data.settings.displayText = ShadowLoadDefaultBarTextNarrowAdvancedSettings()
				ReloadUI()			
			end,
			timeout = 0,
			whileDead = true,
		...
		yCoord = yCoord - 40
		controls.textDisplaySection = TRB.UiFunctions.BuildSectionHeader(parent, "Fortress of the Mind", xCoord+xPadding, yCoord)
		yCoord = yCoord - 30
