...
if classIndexId == 11 then --Only do this if we're on a Druid!
	...
	local function BalanceConstructFontAndTextPanel(parent)
		...
		controls.colors.dotDown = TRB.UiFunctions.BuildColorPicker(parent, "DoT is not active oncurrent target", TRB.Data.settings.druid.balance.colors.text.dots.down, 550, 25, xCoord, yCoord-90)
