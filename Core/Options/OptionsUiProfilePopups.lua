...
TRB.Functions.OptionsUi.ProfilePopups = TRB.Functions.OptionsUi.ProfilePopups or {}
local L = TRB.Localization

-- ============================================================================
-- Profile popup registration and import helpers
-- ============================================================================
	...
	StaticPopupDialogs["TwintopResourceBar_Profile_ImportPaste"] = {
		...
		OnAccept = function(self)
			...
			if parsed == nil then
				...
				elseif err == -8 then
					msg = string.format(L["ProfileImportErrorFlavorMismatch"], TRB.Functions.IO:GetLastRejectedFlavorName(), L[TRB.Flavor.nameKey])
				elseif err == -4 then
...
function TRB.Functions.OptionsUi.ProfilePopups:GetScopeLabel(data)
	if data == nil or data.scope == "core" then
		return L["ProfileScopeLabelGlobal"]
	end
	return data.specLabel or ""
...
function TRB.Functions.OptionsUi.ProfilePopups:EnsureRegistered()
...
function TRB.Functions.OptionsUi.ProfilePopups:ShowProfileImportPopup(onComplete)
	EnsureProfilePopupsRegistered()
