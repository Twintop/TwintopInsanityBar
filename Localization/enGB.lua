...
if locale == "enGB" then
    ...
    L["HunterBeastMasteryCheckboxBestialWrathTooltip"] = "This will change the bar's colour when bestial Wrath is active."
    ...
    L["PriestShadowCheckboxVoidformEndTooltip"] = "Changes the bar colour when Voidform is ending in the next X GCDs or fixed length of time. Select which to use from the options below."
    ...
    L["HunterBeastMasteryCheckboxBestialWrathEndTooltip"] = "Changes the bar colour when Bestial Wrath is ending in the next X GCDs or fixed length of time. Select which to use from the options below."
    ...
    L["DemonHunterDevourerCheckboxCollapsingStarReadyTooltip"] = "This will change the bar colour when Collapsing Star is ready."
    L["DemonHunterDevourerCheckboxEndOfMetamorphosis"] = "Change bar colour at the end of Void Metamorphosis"
    L["DemonHunterDevourerCheckboxEndOfMetamorphosisTooltip"] = "Changes the bar colour when Void Metamorphosis is ending in the next X GCDs or fixed length of time. Select which to use from the options below."
    ...
    L["EvokerAugmentationCheckboxEbonMightDropDuringCastTooltip"] = "Changes the bar colour when you are casting an ability that extends Ebon Might but the cast will not complete before the buff expires."
    L["EvokerAugmentationCheckboxEbonMightTooltip"] = "Changes the bar colour when you have the Ebon Might buff."
    L["EvokerAugmentationCheckboxEndOfEbonMightTooltip"] = "Changes the bar colour when Ebon Might is about to expire based on GCDs or time remaining."
    ...
    L["PriestShadowCheckboxEntropicRiftTooltip"] = "This will change the bar border colour while Entropic Rift is active."
    ...
    L["EvokerDevastationCheckboxDragonrage"] = "Change bar colour when Dragonrage is active"
