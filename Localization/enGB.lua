...
if locale == "enGB" then
    ...
    L["RogueAssassinationCheckboxAlwaysDefaultBackground"] = "When checked, unfilled combo points will always use the 'Unfilled Combo Point background' colour above for their background. Borders will still change colour depending on Supercharger and Serrated Bone Spike settings."
    ...
    L["RogueAssassinationColorPickerThresholdSpecialSpecialEnabled"] = "Change Garrote threshold line colour?"
    L["RogueAssassinationColorPickerThresholdSpecialSpecialEnabledTooltip"] = "When checked, the threshold line colour of Garrote will be changed when the Improved Garrote effect is active."
    L["RogueOutlawColorPickerThresholdSpecialSpecialEnabled"] = "Enable special ability threshold line colour?"
    L["RogueOutlawColorPickerThresholdSpecialSpecialEnabledTooltip"] = "When checked, the threshold line colour of an ability that is being buffed by Skull and Crossbones, Ruthless Precision, or Opportunity."
    L["RogueSubtletyColorPickerThresholdSpecialSpecialEnabled"] = "Enable special ability threshold line colour?"
    L["RogueSubtletyColorPickerThresholdSpecialSpecialEnabledTooltip"] = "When checked, the threshold line colour of an ability that is being buffed by Finality, Silent Storm, or Coup de Grace."
    ...
    L["DemonHunterHavocThresholdSpecialEnabled"] = "Enable special ability threshold line colour?"
    L["DemonHunterHavocThresholdSpecialEnabledTooltip"] = "When checked, the threshold line colour of an ability that is being buffed by Chaos Theory, Glaive Flurry, or Rending Strike."
    L["DemonHunterVengeanceThresholdSpecialEnabled"] = "Enable special ability threshold line colour?"
    L["DemonHunterVengeanceThresholdSpecialEnabledTooltip"] = "When checked, the threshold line colour of an ability that is being buffed by Soul Furnace."
