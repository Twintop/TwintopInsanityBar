...
if locale == "enGB" then
    ...
    L["TargetCastbarEmpowerStageLineColor"] = "Empower Stage Line Colour"
    L["CastbarColorEmpower"] = "Empower Colour"
    L["CopyMenuSection_targetCastbarColors"] = "Target Cast Bar Colours"
    L["CopyMenuSection_focusCastbarColors"] = "Focus Cast Bar Colours"
    L["CheckboxUseGlobalTooltip_TargetCastbarColors"] = "When checked, the global Target Cast Bar fill, interrupt, border, and background colours will be used."
    L["CheckboxUseGlobalTooltip_TargetCastbarEmpower"] = "When checked, the global Target Cast Bar empower colouring and stage line settings will be used."
    L["CheckboxUseGlobalTooltip_FocusCastbarColors"] = "When checked, the global Focus Cast Bar fill, interrupt, border, and background colours will be used."
    L["CheckboxUseGlobalTooltip_FocusCastbarEmpower"] = "When checked, the global Focus Cast Bar empower colouring and stage line settings will be used."
