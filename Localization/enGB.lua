...
if locale == "enGB" then
    ...
    L["CheckboxUseGlobalTooltip_Font"] = "When checked, the global settings for the default font face, colour, and size will be used by any bar text that have 'use default' toggled on."
    ...
    L["MageArcaneChargesCheckboxUseHighestForAll"] = "When checked, the highest Arcane Charge's colour will be used for all Arcane Charges.. E.g., if you have maximum 4 Arcane Charges and currently have 3, the Penultimate colour will be used for all Arcane Charges instead of just the second to last."
    L["MageArcaneChargesCheckboxUseHighestForAllTooltip"] = "Use highest Arcane Charge colour for all?"
