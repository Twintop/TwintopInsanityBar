...
if locale == "zhCN" then
	...
	L["PriestShadowBarTextVariable_resonantEnergyStacks"] = "共振能量增益的层数"
	L["PriestShadowBarTextVariable_resonantEnergyTime"] = "共振能量增益剩余持续时间"
	L["PriestShadowBarTextVariable_voidVolleyCharges"] = "虚空齐射可用充能层数"
	L["PriestShadowBarTextVariable_voidVolleyTime"] = "虚空齐射增益剩余持续时间"
	L["PriestShadowCheckboxResonantEnergy"] = "共振能量"
	L["PriestShadowIndicatorResonantEnergyTooltip"] = "当共振能量处于激活状态且层数大于等于下方设定数值时切换为此颜色。"
