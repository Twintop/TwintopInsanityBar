...
if locale == "frFR" then
    ...
    L["SupportedSpecs"] = "Spécialisations prises en charge (The War Within)"
    ...
    L["AddNewBarTextArea"] = "Ajouter une nouvelle zone de barre de texte"
    L["Name"] = "Nom"
    ...
    L["WarlockAfflictionBarTextVariable_nightfallTime"] = "Temps restant de Crépuscule"
    L["WarlockAfflictionCheckboxNightfall"] = "Proc de Crépuscule"
    L["WarlockAfflictionCheckboxNightfallTooltip"] = "La couleur de la bordure de barre change quand vous obtenez un proc de Crépuscule"
    L["WarlockAfflictionColorPickerNightfall"] = "Crépusule est actif"
    L["WarlockAfflictionCheckboxTormentedCrescendo"] = "Proc de Crescendo torturé"
    L["WarlockAfflictionCheckboxTormentedCrescendoTooltip"] = "La couleur de la bordure de barre change quand vous obtenez un proc de Crescendo torturé"
    L["WarlockAfflictionColorPickerTormentedCrescendo"] = "Crescendo torturé est actif"
    L["WarlockAfflictionBarTextVariable_tormentedCrescendoTime"] = "Temps restant de Crescendo torturé"
    L["WarlockAfflictionBarTextVariable_tormentedCrescendoStacks"] = "Nombre de stack de Crescendo torturé"
    L["WarlockAfflictionBarTextVariable_phantomSingularityTime"] = "Temps restant de Singularité fantomatique sur votre cible"
    L["WarlockAfflictionBarTextVariable_unstableAfflictionTime"] = "Temps restant d'Affliction instable sur votre cible"
    L["WarlockAfflictionBarTextVariable_agonyTime"] = "Temps restant d'Agonie sur votre cible"
    L["WarlockAfflictionBarTextVariable_corruptionTime"] = "Temps restant de Corruption sur votre cible"
    L["WarlockAfflictionBarTextVariable_hauntTime"] = "Temps restant de Hanter sur votre cible"
    L["WarlockAfflictionBarTextVariable_vileTaintTime"] = "Temps restant de Souillure infâme sur votre cible"
    L["WarlockAfflictionBarTextVariable_soulRotTime"] = "Temps restant de Pourriture d'âme sur votre cible"
    L["WarlockAfflictionBarTextVariable_agonyCount"] = "Nombre d'Agonies actifs sur les cibles"
    L["WarlockAfflictionBarTextVariable_corruptionCount"] = "Nombre de Corruptions actifs sur les cibles"
    L["WarlockAfflictionBarTextVariable_hauntCount"] = "Nombre de Hanters actifs sur les cibles"
    L["WarlockAfflictionBarTextVariable_vileTaintCount"] = "Nombre de Souillure infâme actifs sur les cibles"
    L["WarlockAfflictionBarTextVariable_soulRotCount"] = "Nombre de Pourriture d'âme actifs sur les cibles"
    ...
    L["UseDefaultFontColorTooltip"] = "Cela fera que la zone de barre de texte utilisera la couleur par défaut au lieu de la couleur choisie au-dessus"
    ...
    L["PriestShadowBarTextVariable_cttvEquipped"] = "Vérifie si vous êtes équipé de l'Appel du Vide. Variable Logique uniquement"
    L["PriestShadowBarTextVariable_loiTicks"] = "Nombre de tic restants de toutes les tentacules du Vide/flagellants du Vide active"
    L["PriestShadowBarTextVariable_mbGcds"] = "Nombre de GCD restant sur le Torve-esprit/Ombrefiel"
    L["PriestShadowBarTextVariable_mbInsanity"] = "Insanité venant de Torve-esprit/Ombrefiel (comme configuré)"
    L["PriestShadowBarTextVariable_mbSwings"] = "Nombre de coups restant sur le Torve-esprit/Ombrefiel"
    L["PriestShadowBarTextVariable_mbTime"] = "Temps restant sur le Torve-esprit/Ombrefiel"
    ...
    L["PriestShadowBarTextVariable_mindBlastMaxCharges"] = "Nombre maximum de charge d'Attaque Mental"
    L["PriestShadowBarTextVariable_passive"] = "Insanité venant de sources passives"
    L["PriestShadowBarTextVariable_reStacks"] = "Nombre de cumul d'Énergie Résonante sur votre cible actuelle"
    L["PriestShadowBarTextVariable_reTime"] = "Temps restant d'Énergie Résonante sur votre cible actuelle"
    L["PriestShadowBarTextVariable_sfCount"] = "Nombre total d'Omrefiel/Torve-esprit/Âme en peine du Vide actuellement invoqué"
    L["PriestShadowBarTextVariable_siTime"] = "Temps restant sur l'amélioration Claivoyance Ténébreuse"
    L["PriestShadowBarTextVariable_spCrit"] = "Attaque Mental augmente les chances critique de l'amélioration Détresse Psychique "
    L["PriestShadowBarTextVariable_spStacks"] = "Nombre de cumul de l'amélioration Détresse Psychique"
    L["PriestShadowBarTextVariable_spTime"] = "Temps restant de l'amélioration Détresse Psychique"
    L["PriestShadowBarTextVariable_swpCount"] = "Nombre de Mot de l'Ombre: Douleur sur les cibles active"
    L["PriestShadowBarTextVariable_swpTime"] = "Temps restant sur Mot de l'Ombre: Douleur sur votre cible actuelle"
    L["PriestShadowBarTextVariable_tfbTime"] = "Temps restant sur Une Chose de l'Au-delà"
    L["PriestShadowBarTextVariable_tofTime"] = "Temps restant sur l'amélioration Tour du Destin"
    L["PriestShadowBarTextVariable_vfTime"] = "Temps restant de la Forme du Vide"
    L["PriestShadowBarTextVariable_voidVolleyTime"] = "Temps restant sur l'amélioration  Salve du Vide"
    L["PriestShadowBarTextVariable_vtCount"] = "Nombre de Toucher Vampirique actif sur les cibles"
    L["PriestShadowBarTextVariable_vtTime"] = "Temps restant sur Toucher Vampirique sur votre cible actuelle"
    L["PriestShadowBarTextVariable_ysRemainingStacks"] = "Nombre de cumul de Yogg-Saron jusqu'au prochain Chose de l'Au-delà"
    L["PriestShadowBarTextVariable_ysStacks"] = "Nombre de cumul de Yogg-Saron"
    L["PriestShadowBarTextVariable_ysTime"] = "Temps restant sur l'amélioration Yogg-Saron"
    L["PriestShadowCheckboxCritMindBlast"] = "100% Critique Attaque Mentale"
    L["PriestShadowCheckboxCritMindBlastTooltip"] = "Cela modifiera la couleur de bordure de la barre quand votre Attaque Mentale aura 100% de chance critique"
    L["PriestShadowCheckboxInstantMindBlast"] = "Changement de couleur d'Attaque Mentale instantané activé"
    L["PriestShadowCheckboxInstantMindBlastTooltip"] = "Cela modifiera la couleur de la barre quand Attaque Mentale peut être lancé grâce à l'amélioration Claivoyance Ténébreuse"
    L["PriestShadowCheckboxMindDevourer"] = "Amélioration Dévoreuse d'esprit"
    L["PriestShadowCheckboxMindFlayInsanity"] = "Fouet Mentale: Insanité"
    L["PriestShadowCheckboxMindFlayInsanityTooltip"] = "Cela modifiera la couleur de la bordure de la barre quand vous pourrez lancé Fouet Mentale: Insanité"
    L["PriestShadowCheckboxShadowfiendGcds"] = "Insanité venant des GCD restant"
    L["PriestShadowCheckboxShadowfiendSwings"] = "Insanité venant des Coups restant"
    L["PriestShadowCheckboxShadowfiendTime"] = "Insanité du Temps restant"
    L["PriestShadowCheckboxThresholdOvercapTooltip"] = "Cela modifiera la couleur du texte d'Insanité quand votre sort lancé résultera d'un dépassement d'Insanité (comme configuré)"
    L["PriestShadowCheckboxTrackShadowfiendInsanityGain"] = "Suivi des Gains d'Insanité d'Ombrefiel/Torve-esprit"
    L["PriestShadowCheckboxTrackShadowfiendInsanityGainTooltip"] = "Montre le gain d'Insanité sur les prochains Coups, GCD ou une période de temps fixe. Sélectionne laquelle de ses options suivre en-dessous."
    L["PriestShadowCheckboxVoidformGcds"] = "GCDs jusqu'à la fin de la Forme du Vide "
    L["PriestShadowCheckboxVoidformTime"] = "Temps restant jusqu'à la fin de la Forme du Vide"
    L["PriestShadowCheckboxVoidVolley"] = "Salve du Vide"
    L["PriestShadowCheckboxVoidVolleyTooltip"] = "Cela modifiera la couleur de bordure de la barre quand vous pourrez lancé Salve du Vide"
    L["PriestShadowColorPickerCasting"] = "Insanité venant des sorts lancés"
    L["PriestShadowColorPickerCritMindBlast"] = "Bordure quand Attaque Mentale a 100% de chance critique"
    L["PriestShadowColorPickerHasteHigh"] = "Haute Hâte% en Forme du Vide"
    L["PriestShadowColorPickerHasteLow"] = "Basse Hâte% en Forme du Vide"
    L["PriestShadowColorPickerHasteMedium"] = "Moyenne Hâte% en Forme du Vide"
    L["PriestShadowColorPickerInstantMindBlast"] = "Insanité quand Attaque Mentale est lancé instantanément"
    L["PriestShadowColorPickerMindDevourer"] = "L'amélioration Dévoreuse d'Esprit est active"
    L["PriestShadowColorPickerMindFlayInsanity"] = "Bordure quand vous pouvez canalisé Fouet Mentale: Insanité"
    L["PriestShadowColorPickerOvercap"] = "Le lancement du sort provoquera un dépassement d'Insanité"
    L["PriestShadowColorPickerPassive"] = "Insanité venant de sources passives (e.g Esprits de bon Augure, Coups d'Ombrefiel, Torve-esprit)"
    L["PriestShadowColorPickerTextCasting"] = "Insanité des sorts lancés"
    L["PriestShadowColorPickerTextCurrent"] = "Insanité actuelle"
    L["PriestShadowColorPickerVoidVolley"] = "Bordure quand vous pouvez lancé Salve du Vide"
    L["PriestShadowHasteLowToMedium"] = "Seuil Bas à Moy. Hâte% en Forme du Vide "
    L["PriestShadowHasteMediumToHigh"] = "Seuil Moy. à Haute Hâte% en Forme du Vide"
    L["PriestShadowHeaderAuspiciousSpiritsTracking"] = "Suivi d'Esprits de bon Augure"
    L["PriestShadowHeaderEndOfVoidformConfiguration"] = "Configuration de fin de Forme du Vide"
    L["PriestShadowHeaderEternalCallToTheVoidTracking"] = "Suivi d'Éternelle convocation du Vide / Tentacules du Vide + Flagellant du Vide"
    ...
    L["PriestShadowShadowfiendGcds"] = "GCDs d'Ombrefield/Torve-esprit - Arrondi0.75sec"
    L["PriestShadowShadowfiendSwings"] = "Coups d'Ombrefield/Torve-esprit "
    L["PriestShadowShadowfiendTime"] = "Ombrefield/Torve-esprit restant (sec)"
    ...
    L["PriestShadowThresholdShadowfiend"] = "Gain d'Insanité d'Ombrefiel / Torve-esprit"
    L["PriestShadowTrackingCheckboxAuspiciousSpirits"] = "Suivre Esprits de bon Augure"
    L["PriestShadowTrackingCheckboxAuspiciousSpiritsTooltip"] = "Suivre les Apparitions Ténébreuses en vol qui généreront de l'insanité en atteignant leur cible avec le talent Esprits de bon augure."
    L["PriestShadowTrackingCheckboxEternalCallToTheVoid"] = "Suivre Éternelle convocation du Vide"
    L["PriestShadowTrackingCheckboxEternalCallToTheVoidTooltip"] = "Suivre l'Insanité généré venant des apparitions  de Fouet d'Insanité via Tentacules du Vide + Flagellant du Vide / Éternelle convocation du Vide"
