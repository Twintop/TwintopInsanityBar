...
L["HunterBeastMasteryColorPickerBestialWrath"] = "Focus color when you can use Bestial Wrath"
L["HunterBeastMasteryCheckboxBestialWrath"] = "Change when Bestial Wrath is usable"
L["HunterBeastMasteryCheckboxBestialWrathTooltip"] = "This will change the bar's color when Bestial Wrath is usable."
