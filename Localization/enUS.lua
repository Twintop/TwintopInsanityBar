...
L["ResetBarTextAdvancedDialog"] = "Do you want to reset Twintop's Resource Bar's text (including font size, font style, and text information) back to its default (advanced) configuration? Only the %s settings will be changed. This will cause your UI to be reloaded!"
...
L["DruidBalanceColorPickerCurrent"] = "Current Astral Power"
L["DruidBalanceColorPickerCasting"] = "Astral Power from hardcasting spells"
L["DruidBalanceColorPickerPassive"] = "Passive Astral Power"
...
L["DruidRestorationDotChangeColorCheckboxTooltip"] = "When checked, the color of total DoTs up counters and DoT timers ($moonfireCountr, $sunfireCount) will change based on whether or not the DoT is on the current target."