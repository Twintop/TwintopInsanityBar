...
L["RogueAudioCheckboxComboPointThreshold1"] = "Play audio cue when at or above X Combo Points (Threshold 1)"
L["RogueAudioCheckboxComboPointThreshold1Tooltip"] = "Play an audio cue when your current Combo Points reaches or exceeds the configured value to the right."
L["RogueAudioComboPointThreshold2"] = "Combo Point Threshold 2"
L["RogueAudioCheckboxComboPointThreshold2"] = "Play audio cue when at or above X Combo Points (Threshold 2)"
L["RogueAudioCheckboxComboPointThreshold2Tooltip"] = "Play an audio cue when your current Combo Points reaches or exceeds the configured value to the right."
...
L["DruidFeralAudioCheckboxComboPointThreshold1"] = "Play audio cue when at or above X Combo Points (Threshold 1)"
L["DruidFeralAudioCheckboxComboPointThreshold1Tooltip"] = "Play an audio cue when your current Combo Points reaches or exceeds the configured value to the right."
L["DruidFeralAudioComboPointThreshold2"] = "Combo Point Threshold 2"
L["DruidFeralAudioCheckboxComboPointThreshold2"] = "Play audio cue when at or above X Combo Points (Threshold 2)"
L["DruidFeralAudioCheckboxComboPointThreshold2Tooltip"] = "Play an audio cue when your current Combo Points reaches or exceeds the configured value to the right."
L["DruidFeralComboPointThresholdSliderTitle"] = "At or Above X Combo Points"
L["MonkAudioChiThreshold1"] = "Chi Threshold 1"
L["MonkAudioCheckboxChiThreshold1"] = "Play audio cue when at or above X Chi (Threshold 1)"
L["MonkAudioCheckboxChiThreshold1Tooltip"] = "Play an audio cue when your current Chi reaches or exceeds the configured value to the right."
L["MonkAudioChiThreshold2"] = "Chi Threshold 2"
L["MonkAudioCheckboxChiThreshold2"] = "Play audio cue when at or above X Chi (Threshold 2)"
L["MonkAudioCheckboxChiThreshold2Tooltip"] = "Play an audio cue when your current Chi reaches or exceeds the configured value to the right."
L["MonkChiThresholdSliderTitle"] = "At or Above X Chi"
L["ShamanAudioMaelstromWeaponThreshold1"] = "Maelstrom Weapon Threshold 1"
L["ShamanAudioCheckboxMaelstromWeaponThreshold1"] = "Play audio cue when at or above X Maelstrom Weapon stacks (Threshold 1)"
L["ShamanAudioCheckboxMaelstromWeaponThreshold1Tooltip"] = "Play an audio cue when your current Maelstrom Weapon stacks reaches or exceeds the configured value to the right."
L["ShamanAudioMaelstromWeaponThreshold2"] = "Maelstrom Weapon Threshold 2"
L["ShamanAudioCheckboxMaelstromWeaponThreshold2"] = "Play audio cue when at or above X Maelstrom Weapon stacks (Threshold 2)"
L["ShamanAudioCheckboxMaelstromWeaponThreshold2Tooltip"] = "Play an audio cue when your current Maelstrom Weapon stacks reaches or exceeds the configured value to the right."
...
L["WarlockAudioCheckboxSoulShardThreshold1"] = "Play audio cue when at or above X Soul Shards (Threshold 1)"
L["WarlockAudioCheckboxSoulShardThreshold1Tooltip"] = "Play an audio cue when your current Soul Shards reaches or exceeds the configured value to the right."
L["WarlockAudioSoulShardThreshold2"] = "Soul Shard Threshold 2"
L["WarlockAudioCheckboxSoulShardThreshold2"] = "Play audio cue when at or above X Soul Shards (Threshold 2)"
L["WarlockAudioCheckboxSoulShardThreshold2Tooltip"] = "Play an audio cue when your current Soul Shards reaches or exceeds the configured value to the right."
...
L["MageAudioCheckboxArcaneChargeThreshold1"] = "Play audio cue when at or above X Arcane Charges (Threshold 1)"
L["MageAudioCheckboxArcaneChargeThreshold1Tooltip"] = "Play an audio cue when your current Arcane Charges reaches or exceeds the configured value to the right."
L["MageAudioArcaneChargeThreshold2"] = "Arcane Charge Threshold 2"
L["MageAudioCheckboxArcaneChargeThreshold2"] = "Play audio cue when at or above X Arcane Charges (Threshold 2)"
L["MageAudioCheckboxArcaneChargeThreshold2Tooltip"] = "Play an audio cue when your current Arcane Charges reaches or exceeds the configured value to the right."
