...
L["ShamanAudioCheckboxMaelstromWeaponThreshold1"] = "Play when >= X Maelstrom Weapon stacks (Threshold 1)"
...
L["ShamanAudioCheckboxMaelstromWeaponThreshold2"] = "Play when >= X Maelstrom Weapon stacks (Threshold 2)"
