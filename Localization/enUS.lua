...
L["HunterAudioCheckboxKillShotTooltip"] = "Play an audio cue when Kill Shot is usable and off of cooldown. If you also have Flayer's Mark proc audio enabled, that sound takes priority when a proc occurs."
...
L["HunterBeastMasteryThresholdCheckbox"] = "Arcane Shot"
L["HunterBeastMasteryThresholdCheckboxTooltip"] = "This will show the vertical line on the bar denoting how much Focus is required to use Arcane Shot."
